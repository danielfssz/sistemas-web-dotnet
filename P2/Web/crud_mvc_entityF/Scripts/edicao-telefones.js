$(function () {
    ...
    //remove telefones ainda com problemas de nao zerar o ID
    $("#div-telefones").on("click", ".btn-remover-telefone", function (e) {
        ...
        //parent.parent porque o botao esta dentro da col-md-1 q por sua vez esta dentro da div -row
        $(this).parent().parent().remove();

        //resolve o problema de decrementar o indice
        qtdTelefones--;

        //resolve o problema de ordenar os indices a cada exclusao
